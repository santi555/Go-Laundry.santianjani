...
<h2 class="text-center" style=""> PENGGUNA KAMI </h2> <br>
<?php
    if($_SESSION['role'] == "admin"){
      echo"
<a href='form_tambah_user.php' class='btn btn-success' style='margin-bottom: 2cm;'> Tambah Pengguna </a>"; 
}
?>
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><?= $us ['id_outlet']?></td>
                <td><?= $us ['role']?></td>
                <td><a href="form_ubah_user.php?id=<?= $us['id_user']; ?>" class="btn btn-success"> Update </a> 
                <a href="proses_hapus_user.php?id=<?= $us['id_user']; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini')" class="btn btn-danger"> Delete </a> </td>
            </tr>  
<?php endforeach; ?>
        </tbody>
    </table>
