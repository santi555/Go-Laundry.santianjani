...
<h2 class="text-center" style=""> OUR MEMBER </h2> 
<center>
    <table class="table">
    <thead class="thead-dark">
        ...
        <tbody>
            <tr>
                ...
                <td><?= $mem ['telepon']?></td>
                <td><a href="form_ubah_member.php?id=<?= $mem['id_member']; ?>" class="btn btn-success"> Update </a> 
                <a href="proses_hapus_member.php?id=<?= $mem['id_member']; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini')" class="btn btn-danger"> Delete </a> </td>
            </tr>  
<?php endforeach; ?>
        </tbody>
        </center>
